  ...
  private static function alter_tables(){
      global $wpdb;
        ...
        if($ays_pb_infos == 0){
            ...
            $query = "INSERT INTO ".$table." (title, description, category_id, autoclose, cookie, width, height, bgcolor, textcolor, bordersize, bordercolor, border_radius, custom_html, onoffswitch, show_all, delay, scroll_top, animate_in, animate_out, action_button_type, modal_content, view_type, onoffoverlay, show_popup_title,  show_popup_desc, close_button, header_bgcolor, bg_image, log_user, guest, active_date_check, activeInterval, deactiveInterval, pb_position, pb_margin) VALUES ('Demo Title', 'Demo Description', '1' , '20', '0', '400', '500', '#ffffff', '#000000', '1', '#ffffff', '4', 'My first Popup', 'On', 'all', '0', '0', 'fadeIn', 'fadeOutUpBig', 'pageLoaded', 'custom_html', 'default', 'On', 'On', 'On','off', '#ffffff', '', 'On', 'On', 'off', '', '','center-center', '0')";
            $wpdb->query( $query );
        }
  }
}
