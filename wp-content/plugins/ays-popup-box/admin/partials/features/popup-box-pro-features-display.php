        ...
        <div class="comparison">
            <table>
                ...
                <tr>
                    ...
                    <th class="price-info">
                        <!-- <div class="price-now"><span style="text-decoration: line-through; color: red;">$29</span> -->
                        <div class="price-now"><span>$29</span>
                        <!-- <div class="price-now"><span>$23</span></div> -->
                        <!-- <div class="price-now"><span style="color: red; font-size: 12px;">Until January 1</span> -->
                    </th>
                    <th class="price-info">
                        <!-- <div class="price-now"><span style="text-decoration: line-through; color: red;">$89</span> -->
                ...
                <tr>
                    <td></td>
                    <td colspan="4">
                        <?php echo __( 'Accept cookie popup', $this->plugin_name ); ?>
                    </td>
                </tr>
                <tr class="compare-row">
                    <td>
